...
const Service1 = new MyService({name: "Обои флезилиновые", cost: 950});
const Service2 = new MyService({name: "Фотобумага 220гр", cost: 580});
const Service3 = new MyService({name: "Постерная бумага 150гр", cost: 460});
