...
const Banner1 = new MyService({name: "Обои флезилиновые", cost: 950});
const Banner2 = new MyService({name: "Фотобумага 220гр", cost: 580});
const Banner3 = new MyService({name: "Постерная бумага 150гр", cost: 460});
