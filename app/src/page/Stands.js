...
const Service1 = new MyService({name: "Orakal", cost: 0});
const Service2 = new MyService({name: "Пленка с полноцветной печатью", cost: 0});
const Service3 = new MyService({name: "Пленка с УФ печатью", cost: 0});
const Service4 = new MyService({name: "Стикерпаки", cost: 0});
