...
const Banner1 = new MyService({name: "Orakal", cost: 0});
const Banner2 = new MyService({name: "Пленка с полноцветной печатью", cost: 0});
const Banner3 = new MyService({name: "Пленка с УФ печатью", cost: 0});
const Banner4 = new MyService({name: "Стикерпаки", cost: 0});
